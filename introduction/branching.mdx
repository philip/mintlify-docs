...
<CardGroup>
  ...
  <Card title="Branching with GitHub Actions" icon="split-branch" href="/guides/branching-github-actions">
    Automate branching with Neon's GitHub Actions for branching
  </Card>

  <Card title="The Neon-Managed Vercel Integration" icon="split-branch" href="/guides/neon-managed-vercel-integration">
...
<CardGroup>
  ...
  <Card title="Instant restore" icon="invert" href="/guides/branch-restore">
    Restore a branch to an earlier point in its history
  </Card>

  <Card title="Reset from parent" icon="split-branch" href="/guides/reset-from-parent">
    Reset a branch to match its parent
  </Card>

  <Card title="Time Travel queries" icon="queries" href="/guides/time-travel-assist">
