...
![Neon architecture overview](/images/docs/introduction/neon-architecture-overview.png)
...
![Write path in Neon](/images/docs/introduction/neon-write-path.png)
...
![Read path in Neon](/images/docs/introduction/neon-read-path.png)
