...
<a href="/introduction/plans">Neon plans</a>
<a href="/introduction/monitor-usage">Monitoring billing and usage</a>
...
If you are unable to update your payment method, please [contact support](/introduction/support).
...
If you are unable to update your billing email, please [contact support](/introduction/support).

## Invoices

A Neon invoice includes the charges and the amount due for the billing period. For an explanation of what you've been billed for, see [Usage metrics](/introduction/plans#usage-metrics).
...
<Note title="Restart required for new limits">
If you're upgrading your plan, your compute will only pick up the new plan limits (such as max compute size and project storage) after the compute restarts. See [Restart a compute](/manage/computes#restart-a-compute).
</Note>
...
Changing your plan to one with lower usage allowances may affect the performance of your applications. To compare plan allowances, see [Neon plans](/introduction/plans#neon-plans).
...
If you would like to delete your Neon account entirely, please refer to the steps described here: [Deleting your account](/manage/accounts#delete-account).
