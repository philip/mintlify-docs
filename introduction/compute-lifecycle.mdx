...
description: >-
  Covers the states of compute in Neon, detailing the transition between idle
  and active states, the scale to zero feature, and the activation process for
...
![Scale to zero configuration dialog](/images/docs/introduction/autoscaling_config.png)

For information about configuring this setting, see [Edit a compute](/manage/computes#edit-a-compute).
...
![Compute state](/images/docs/introduction/compute_state.png)
...
For more, see [Session context](/reference/compatibility#session-context).
