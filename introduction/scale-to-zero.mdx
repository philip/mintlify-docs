...
![Compute metrics graph](/images/docs/introduction/compute-usage-graph.jpg)
...
You can enable or disable the scale-to-zero setting by editing your compute settings. For detailed instructions, see [Configuring scale to zero for Neon computes](/guides/scale-to-zero-guide).
