...
<a href="/introduction/autoscaling">Introduction to autoscaling</a>
<a href="/guides/autoscaling-guide">Enabling autoscaling</a>
...
![High-level architecture diagram](/images/docs/introduction/autoscale-high-level-architecture.jpg)

Looking more closely, you can see that each Postgres instance operates within its own virtual machine inside a [Kubernetes cluster](/reference/glossary#kubernetes-cluster), with multiple VMs hosted on each node of the cluster. Autoscaling is implemented by allocating and deallocating compute resources ([RAM](/reference/glossary#ram)) to each VM.

![Autoscaling diagram](/images/docs/introduction/autoscale-architecture.jpg)
