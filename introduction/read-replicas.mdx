...
<CardGroup>
  ...
  <Card title="Create and manage Read Replicas" icon="ladder" href="/guides/read-replica-guide">
    Learn how to create, connect to, configure, delete, and monitor read replicas
  </Card>

  <Card title="Scale your app with Read Replicas" icon="scale-up" href="/guides/read-replica-integrations">
    Scale your app with read replicas using built-in framework support
  </Card>

  <Card title="Run analytics queries with Read Replicas" icon="chart-bar" href="/guides/read-replica-data-analysis">
    Leverage read replicas for running data-intensive analytics queries
  </Card>

  <Card title="Run ad-hoc queries with Read Replicas" icon="queries" href="/guides/read-replica-adhoc-queries">
    Leverage read replicas for running ad-hoc queries
  </Card>

  <Card title="Provide read-only access with Read Replicas" icon="screen" href="/guides/read-only-access-read-replicas">
