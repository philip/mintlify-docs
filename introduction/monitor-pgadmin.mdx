...
![PgAdmin monitoring dashboard](/images/docs/introduction/pgadmin_monitor.png)
...
- Block I/O for shared buffers (see [Cache your data](/postgresql/query-performance#cache-your-data) for information about Neon's Local File Cache)
...
Enter your connection details as shown [here](/connect/connect-postgres-gui#connect-to-the-database).
