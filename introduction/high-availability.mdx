...
![Neon architecture diagram](/images/docs/introduction/neon_architecture_5.jpg)
...
![HA storage failover](/images/docs/introduction/HA-storage-failover.png)
...
![Postgres restarting after failure](/images/docs/introduction/postgres_fails.png)
...
![VM restarting after failure](/images/docs/introduction/vm_fails.png)
...
For details on uptime and performance guarantees, refer to our available [SLAs](/introduction/support#slas).
