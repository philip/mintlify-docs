...
![PgHero Dashboard](/images/docs/introduction/pg_hero.png)
...
<Note>
Neon does not currently support monitoring tools or platforms that require installing an agent on the Postgres host system, but please keep an eye on our [roadmap](/introduction/roadmap) for future integrations that enable these monitoring options. 
</Note>
...
- Ensure that you have the [pg_stat_statements](/extensions/pg_stat_statements) extension installed. PgHero uses it for query stats.
