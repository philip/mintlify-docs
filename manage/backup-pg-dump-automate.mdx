...
<CardGroup>
  ...
  <Card title="Part 1: Create an S3 bucket to store backups" icon="database" href="/manage/backups-aws-s3-backup-part-1">
    Set up an AWS S3 bucket for storing backups
  </Card>

  <Card title="Part 2: Automate with GitHub Actions" icon="stopwatch" href="/manage/backups-aws-s3-backup-part-2">
