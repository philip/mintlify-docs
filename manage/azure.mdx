...
<CardGroup>
  ...
  <Card title="Deploy Neon on Azure" icon="enable" href="/azure/azure-deploy">
    Deploy Neon Postgres as Native ISV Service from the Azure Marketplace
  </Card>

  <Card title="Manage billing on Azure" icon="enable" href="/introduction/billing-azure-marketplace">
    Manage billing for the Neon Native ISV Service on Azure
  </Card>

  <Card title="Manage Neon on Azure" icon="cli" href="/azure/azure-manage">
    How to manage your Neon Native ISV Service on Azure
  </Card>

  <Card title="Develop with Neon on Azure" icon="code" href="/azure/azure-develop">
