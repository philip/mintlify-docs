...
![Open the profile menu and select Account settings.](/images/docs/manage/profile_dropdown.png)
...
![Personal information section in Account settings](/images/docs/manage/personal_profile.png)
...
**If you signed up with email,** it's not currently possible to switch to a social login. [Contact Support](/introduction/support) and we'll help you out.
...
[Learn more about API keys](/manage/api-keys)

![Personal API keys section in Account settings.](/images/docs/manage/personal_api_key.png)
...
See [Account Recovery](/manage/account-recovery) for step-by-step instructions if you need to regain access to a Neon account.
