...
See more details about using this endpoint on the [Manage billing with consumption limits](/guides/consumption-limits#retrieving-metrics-for-all-projects) page in our Platform integration guide.
