...
![Creating a personal API key in the Neon Console](/images/docs/manage/personal_api_key.png)
</Tab>
...
For more detail about organization-related methods, see [Organization API Keys](/manage/orgs-api#api-keys).
...
![creating an api key from the console](/images/docs/manage/org_api_keys.png)
</Tab>
...
Project-scoped API keys have [member-level access](/manage/organizations#user-roles-and-permissions), meaning they **cannot** delete the project they are associated with. These keys:
...
![Project-scoped API keys from the Console](/images/docs/manage/project_scoped_select.png)
...
![Revoking an API key in the Neon Console](/images/docs/manage/revoke_api_key.png)
</Tab>
