...
- [Update the email address](/manage/accounts#update-personal-information)
- [Transfer project ownership](/manage/orgs-project-transfer)
- [Add an admin](/manage/orgs-manage#set-permissions) to your projects or organization
- [Update billing details](/introduction/manage-billing)
