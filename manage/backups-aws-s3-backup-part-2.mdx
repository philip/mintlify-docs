...
<Note>
This is part two of a two-part guide. Make sure you've completed [part 1](/manage/backups-aws-s3-backup-part-1) first.
</Note>
...
![Neon Console](/images/docs/manage/2-s3-backups-github-actions-01-neon-projects.jpg)
...
![Neon Console](/images/docs/manage/2-s3-backups-github-actions-02-github-workflows.jpg)
...
![GitHub Secrets](/images/docs/manage/2-s3-backups-github-actions-03-github-secrets.jpg)
...
Restoring a `pg_dump` backup requires downloading the file from S3 and restoring it using `pg_restore`. For instructions, see [Restoring a backup with pg_restore](/manage/backup-pg-dump#restoring-a-backup-with-pgrestore).
