...
Authentication is tied to your Neon user account. Once authenticated, you can access and manage any organization you belong to. When running commands, you'll need to specify which organization to use via `--org-id`, a [context file](/reference/cli-set-context), or by responding to the interactive prompt.

See [Auth - CLI](/reference/cli-auth) to learn more.
...
See [Orgs - CLI](/reference/cli-orgs) to learn more.
...
- [List projects](/reference/cli-projects#list)
- [Create projects](/reference/cli-projects#create)

See [Projects - CLI](/reference/cli-projects) to learn more.
...
Sees [set-context - CLI](/reference/cli-set-context) to learn more.
