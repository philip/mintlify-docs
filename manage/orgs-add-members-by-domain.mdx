...
![Domains page before adding a domain: Domain input field and Add domain button](/images/docs/manage/orgs_domains_empty.png)
...
![Domain added with Pending verification status, Verification TXT record value, and Verify button](/images/docs/manage/orgs_domains_pending.png)
...
- [Manage organizations](/manage/orgs-manage) for inviting members manually and managing roles.
- [User permissions](/manage/user-permissions) for a breakdown of Admin and Member capabilities.
