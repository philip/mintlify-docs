...
![Neon object hierarchy](/images/docs/manage/neon_object_hierarchy.jpg)
...
**API keys** can be personal (global to your account) or scoped to an organization or project. For more details, see [Manage API keys](/manage/api-keys).
