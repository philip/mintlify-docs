...
description: >-
  How to connect to Neon using the `pgcli` client, including obtaining a
  connection string from the Project Dashboard and executing queries with
  enhanced features like autocompletion and query history.
isDraft: false
---
