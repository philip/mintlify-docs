...
For more details, see [Connect from any application](/connect/connect-from-any-app).
...
3. In the **Basic** section, fill in the fields using the details from your connection string.
   ...
   ![Looker studio connection details](/images/docs/connect/ls_connection_details.png)
...
1. Download the `isrgrootx1.pem` file from https://letsencrypt.org/certs/isrgrootx1.pem. For more information about SSL certificates, see [Connect to Neon securely](/connect/connect-securely).
2. In Looker Studio, upload the `isrgrootx1.pem` file using the **Upload** button next to the **Server Certificate** box.

   ![Looker studio upload pem file](/images/docs/connect/ls_pem_file.png)
...
![Looker studio upload pem file](/images/docs/connect/ls_neon_tables.png)

## Connect

Click the **Connect** button in Looker Studio to view table details.

![Looker studio upload pem file](/images/docs/connect/ls_table_details.png)
