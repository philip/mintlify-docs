...
This page shows how to automate data anonymization with GitHub Actions. For conceptual overview and usage instructions, see [Data Anonymization](/workflows/data-anonymization).
...
<Tip>
The Neon GitHub integration configures these secrets automatically. See [Neon GitHub integration](/guides/neon-github-integration).
</Tip>
...
For available masking functions, see [PostgreSQL Anonymizer documentation](https://postgresql-anonymizer.readthedocs.io/en/latest/masking_functions/) or the [Manage masking rules](/workflows/data-anonymization#manage-masking-rules) section of the main guide.
