...
- [json_array_elements](/functions/json_array_elements)
- [jsonb_array_elements](/functions/jsonb_array_elements)
- [json_build_object](/functions/json_build_object)
- [json_each](/functions/json_each)
- [json_extract_path](/functions/json_extract_path)
- [json_extract_path_text](/functions/json_extract_path_text)
- [json_object](/functions/json_object)
- [json_populate_record](/functions/json_populate_record)
- [json_to_record](/functions/json_to_record)
