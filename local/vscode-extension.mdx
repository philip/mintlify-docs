...
Once signed in, the extension automatically configures the [Neon MCP server](/ai/neon-mcp-server) for AI features.
...
<Note>
If you're new to Neon, this reflects our object hierarchy: organizations contain projects, and projects contain branches. [Learn more about how Neon organizes your data.](/manage/overview)
</Note>
...
The Neon extension includes built-in support for AI-powered database features through the [Neon MCP Server](/ai/neon-mcp-server):
...
- [Branching in Neon](/guides/branching-intro).
- [Neon MCP Server](/ai/neon-mcp-server).
- [Serverless driver](/serverless/serverless-driver).
