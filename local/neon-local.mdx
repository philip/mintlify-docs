...
Connect using the Neon [serverless driver](/serverless/serverless-driver).
...
| ------------------ | --------------------------------------------------------------------------------- | -------- | ----------------------------- |
| `NEON_API_KEY`     | Your Neon API key. [Manage API Keys](/manage/api-keys)                       | Yes      | N/A                           |
...
![Docker Desktop are set to gRPC FUSE](/images/docs/local/neon-local-docker-settings.jpg)
