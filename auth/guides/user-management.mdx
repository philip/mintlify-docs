...
<CardGroup>
  ...
  <Card title="Password Reset" icon="/images/icons/lock-landscape.svg" href="/auth/guides/password-reset">
    Reset forgotten passwords
  </Card>

  <Card title="Email Verification" icon="/images/icons/check.svg" href="/auth/guides/email-verification">
