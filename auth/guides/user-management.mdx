...
<Note>
Email address changes are not currently supported. To reset a forgotten password, see [Password Reset](/auth/guides/password-reset).
</Note>
...
<Note>
If a user forgot their password, use the password reset flow (`requestPasswordReset()` and `resetPassword()`) instead. See [Password Reset](/auth/guides/password-reset).
</Note>
...
<CardGroup>
  ...
  <Card title="Password Reset" icon="lock-landscape" href="/auth/guides/password-reset">
  ...
  <Card title="Authentication Flow" icon="unlock" href="/auth/authentication-flow">
