...
- [Add email verification](/auth/guides/email-verification) to ensure users own their email addresses
- [Learn how to branch your auth](/auth/branching-authentication) to use database branches with isolated auth environments
