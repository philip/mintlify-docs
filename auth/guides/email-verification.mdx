...
<Note>
Verification links require a [custom email provider](/auth/production-checklist#email-provider). If you're using the shared email provider, use verification codes instead.
</Note>
...
![Email verification settings in Neon Console](/images/docs/auth/email-verification-settings.png)

## Verification links

Verification links require a custom email provider. See [Email provider configuration](/auth/production-checklist#email-provider) to set this up.
