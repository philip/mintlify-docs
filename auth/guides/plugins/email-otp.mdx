...
- **Sign-up and Sign-in with Email** enabled in your project's **Settings** → **Auth**.
  ...
  <Note title="Email verification during sign-up">
  ...
  ![Email OTP verification code setting](/images/docs/auth/email-otp.png)
  </Note>
...
![Email OTP verification](/images/docs/auth/email-otp-verification.png)

> If you haven't set up Neon Auth UI components yet, see our [Quick start guides](/auth/overview#quick-start-guides).

## Use Email OTP with SDK methods

You can also implement OTP flows directly using the [Neon SDK](/reference/javascript-sdk).
...
> For more details, see the [Send verification OTP code](/reference/javascript-sdk#auth-sendverificationotp) in Neon SDK.
...
> For more details, see the [Sign in with OTP code](/reference/javascript-sdk#auth-signinwithemailotp) in Neon SDK.
...
> For more details, see the [Verify email with OTP code](/reference/javascript-sdk#auth-verifyemail) in Neon SDK.

Checkout our [Email verification guide](/auth/guides/email-verification) for a complete walkthrough.
...
> For more details, see the [Check verification OTP code](/reference/javascript-sdk#auth-checkverificationotp) in Neon SDK.
...
For production environments, we strongly recommend using a dedicated email provider. The default shared SMTP should be used only during development. Refer to the [Email provider configuration guide](/auth/production-checklist#email-provider) for setup instructions.
