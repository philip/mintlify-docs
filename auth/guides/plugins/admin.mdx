...
- An existing user with an **admin** role to call Admin APIs.
  ...
  ![Assign admin role in Neon Console](/images/docs/auth/make-admin.png)

## Use Admin with SDK methods

You can call Admin plugin methods using the Neon SDK auth client.

> If you haven’t set up Neon Auth yet, follow our [Quick start guides](/auth/overview#quick-start-guides) to get started and create an `authClient`.
