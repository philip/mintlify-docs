...
One of Neon Auth's unique features is native support for [database branching](/introduction/branching). Because authentication data (users, sessions, and configuration) lives directly in your database's `neon_auth` schema, it is cloned along with your business data when you create a branch.
...
When you create a [database branch](/introduction/branching), you get an exact copy of all authentication data from the parent branch at that point in time:
...
<Tip>
See the [GitHub Actions guide](/guides/branching-github-actions) for instructions on how to automate branch creation for preview environments.
</Tip>
...
<CardGroup>
  ...
  <Card title="Database Branching" icon="split-branch" href="/introduction/branching">
    Learn about database branching fundamentals
  </Card>

  <Card title="Branching with CLI" icon="cli" href="/guides/branching-neon-cli">
    Create and manage branches with CLI
  </Card>

  <Card title="Branching with GitHub Actions" icon="split-branch" href="/guides/branching-github-actions">
    Automate branching in CI/CD
  </Card>

  <Card title="Row-Level Security" icon="lock-landscape" href="/guides/row-level-security">
