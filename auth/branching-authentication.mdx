...
<CardGroup>
  ...
  <Card title="Database Branching" icon="/images/icons/split-branch.svg" href="/introduction/branching">
    Learn about database branching fundamentals
  </Card>

  <Card title="Branching with CLI" icon="/images/icons/cli.svg" href="/guides/branching-neon-cli">
  ...
  <Card title="Row-Level Security" icon="/images/icons/lock-landscape.svg" href="/guides/row-level-security">
