...
<CardGroup>
  ...
  <Card title="Branching Authentication" icon="/images/icons/split-branch.svg" href="/auth/branching-authentication">
    How auth works with database branches
  </Card>

  <Card title="Row Level Security" icon="/images/icons/check.svg" href="/guides/row-level-security">
