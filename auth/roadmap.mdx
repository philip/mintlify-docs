...
| ----------------------- | ------------ | ------------------------------------------------------------- |
| Next.js                 | ✅ Supported | [Get started](/auth/quick-start/nextjs)                  |
| React + React Router    | ✅ Supported | [Get started](/auth/quick-start/react-router-components) |
| React + TanStack Router | ✅ Supported | [Get started](/auth/quick-start/tanstack-router)         |
| Vite + React            | ✅ Supported | [Get started](/auth/quick-start/react)                   |
...
<Note title="Standalone architectures">
...
| [Admin](/auth/guides/plugins/admin) plugin customization     | 🔜 Coming soon  |
