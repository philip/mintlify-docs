...
<CardGroup>
  ...
  <Card title="Next.js" icon="/images/technology-logos/next-js.svg" href="/auth/quick-start/nextjs">
    With UI components
  </Card>

  <Card title="React (API methods)" icon="/images/technology-logos/react.svg" href="/auth/quick-start/react">
    Build your own auth UI
  </Card>

  <Card title="React" icon="/images/technology-logos/react.svg" href="/auth/quick-start/react-router-components">
    With UI components
  </Card>

  <Card title="TanStack Router" icon="/images/technology-logos/tanstack.svg" href="/auth/quick-start/tanstack-router">
    With UI components
  </Card>
