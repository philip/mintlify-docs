...
<Warning title="Hydration Warning">
      ...
      >
        ...
        > // [!code ++]
          <header className='flex justify-end items-center p-4 gap-4 h-16'> // [!code ++]
            {/* MIGRATION_FLAG: UserButton - No Mintlify equivalent */}
...
<Tip title="Not using Tailwind?">
See [UI Component Styles](/auth/reference/ui-components#styling) for alternative setup options.
</Tip>
