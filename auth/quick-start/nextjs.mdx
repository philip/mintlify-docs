...
<Step title="Install the Neon Auth SDK">
...
<Step title="Wrap app layout with auth provider">
...
<Step title="Add Neon Auth styles">
...
<Step title="Create the Auth & Account pages">
...
<Step title="Access user data on server and client">
**Server Components:**
