...
## auth.signIn.email() {#auth-signin-email}
...
## auth.signIn.social() {#auth-signin-social}
...
## auth.signIn.emailOtp() {#auth-signin-emailotp}
...
## auth.signUp.email() {#auth-signup-email}
...
## auth.sendVerificationEmail() {#auth-sendverificationemail}
...
## auth.emailOtp.sendVerificationOtp() {#auth-emailotp-sendverificationotp}
...
## auth.emailOtp.verifyEmail() {#auth-emailotp-verifyemail}
...
## auth.listSessions() {#auth-listsessions}
...
## auth.revokeSession() {#auth-revokesession}
...
## auth.revokeOtherSessions() {#auth-revokeothersessions}
...
## auth.organization.list() {#auth-organization-list}
...
## auth.organization.inviteMember() {#auth-organization-invitemember}
...
## auth.admin.listUsers() {#auth-admin-listusers}
...
## auth.admin.banUser() {#auth-admin-banuser}
...
## auth.admin.setRole() {#auth-admin-setrole}
