...
- [Next.js Server SDK Reference](/auth/reference/nextjs-server) - Complete API documentation
- [Neon Auth SDK Changelog](https://github.com/neondatabase/neon-js/blob/main/packages/auth/CHANGELOG.md#020-beta1)
- [Next.js Integration Guide](/auth/quick-start/nextjs)
- [Neon Auth Overview](/auth/overview)
