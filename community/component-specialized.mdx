...
```mdx
{/* MIGRATION_FLAG: Video - No Mintlify equivalent */}
<Video
...
<Snippet file="private-preview.mdx" />
<Snippet file="private-preview-enquire.mdx" />
<Snippet file="early-access.mdx" />
<Snippet file="public-preview.mdx" />
<Snippet file="feature-beta.mdx" />
<Snippet file="l-r-beta.mdx" />
<Snippet file="new-pricing.mdx" />
<Snippet file="l-r-notice.mdx" />
...
```mdx
{/* MIGRATION_FLAG: EarlyAccessProps - Parameterized shared content, Mintlify snippets don't support props */}
...
Auto-generated components specifically for SDK documentation. These load content from [shared templates](/community/component-guide#common-shared-components).

### Getting Started

```mdx
{/* MIGRATION_FLAG: GetStarted - No Mintlify equivalent */}
...
```mdx
{/* MIGRATION_FLAG: SdkUser - No Mintlify equivalent */}
<SdkUser sdkName="React" />
{/* MIGRATION_FLAG: SdkProject - No Mintlify equivalent */}
<SdkProject sdkName="Node.js" />
{/* MIGRATION_FLAG: SdkUseUser - No Mintlify equivalent */}
...
For commonly used components, see the [Component Guide](/community/component-guide).
