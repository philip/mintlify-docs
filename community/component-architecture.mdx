...
- How MDX components are structured and organized
- Technical implementation details for each component type
- Development workflows for adding and modifying components
- File organization and build process details
</Card>
...
<a href="/guides/node">Node.js Guide</a>
```
...
```jsx
// In MDX files
<Snippet file="feature-beta.mdx" />  // Loads content from feature-beta.md
<Snippet file="public-preview.mdx" /> // Loads content from public-preview.md
```
...
For component usage examples, see the [Component Guide](/community/component-guide) and [Component Specialized Guide](/community/component-specialized).
