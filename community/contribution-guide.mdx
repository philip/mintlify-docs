...
<Note title="TL;DR: Contributing to the Neon Docs">
...
![GitHub edit this page link](/images/docs/community/edit_this_page.png)
...
For advanced formatting and custom components, see the [Component Guide](/community/component-guide). To add visual diagrams to your documentation, check out our [Mermaid Diagrams Guide](/community/mermaid-diagrams).
...
Neon documentation page link: [Connection from any application](/connect/connect-from-any-app)
...
To display code tabs, enclose all pieces of code within `<CodeTabs></CodeGroup>` and specify labels in order, as shown in the following example:
...
To view this example in the Neon documentation, see [Create a Next.js project and add dependencies](/guides/nextjs#create-a-nextjs-project-and-add-dependencies).

## Callouts

The Neon documentation supports the following callout components:
...
For a complete list of available components and their usage, see the [Component Guide](/community/component-guide).
...
```md
<Note title="Very important note">
...
For technical details about how components are implemented, see the [Component Architecture](/community/component-architecture) guide.
...
```md
![Neon architecture diagram](/images/docs/introduction/neon_architecture.png)
```
...
For the full list of tools, see [AI tools for documentation](/community/ai-tools).

## Additional Resources

When contributing to Neon documentation, you may find these additional resources helpful:

- **[Component Guide](/community/component-guide)**: Complete reference for common MDX components
- **[Component Specialized Guide](/community/component-specialized)**: Advanced and specialized components
- **[Component Icon Guide](/community/component-icon-guide)**: Icon systems and usage guidelines
- **[Component Architecture](/community/component-architecture)**: Technical implementation details
