...
| **Docs editing**          | When editing docs/guides/changelog: apply Neon voice (see [contribution guide](/community/contribution-guide)), use shared content, keep cross-doc consistency, link to glossary, follow redirect workflow. Rule: `docs-editing.mdc`. |
