...
<a href="/community/component-icon-guide">Component Icon Guide</a>
...
<a href="/ai/openai" title="OpenAI integration" description="Build AI features with OpenAI" icon="openai">OpenAI Integration</a>
<a href="/ai/langchain" title="LangChain integration" description="Create AI workflows with LangChain" icon="langchain">LangChain Integration</a>
<a href="/development" title="Code development" description="Development tools and practices" icon="code">Code Development</a>
<a href="/cloud/aws" title="AWS integration" description="Deploy and scale with AWS" icon="aws">AWS Integration</a>
