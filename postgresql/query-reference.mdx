...
For more information and examples, refer to our [pg_stat_statements extension guide](/extensions/pg_stat_statements), or [Gathering statistics](/postgresql/query-performance#gather-statistics) in our query optimization guide.
...
For more information, refer to the [EXPLAIN](/postgresql/query-performance#use-explain) section in our query optimization guide.
...
For related information and more queries, see [Use indexes](/postgresql/query-performance#use-indexes) in our query optimization guide.
...
Also, see the [Use indexes](/postgresql/query-performance#use-indexes) section in our query optimization guide.
...
The `max_connections` setting is configured by Neon according to your compute size configuration. See [Connection limits without connection pooling](/connect/connection-pooling#connection-limits-without-connection-pooling).

<Tip>
You can use [connection pooling](/connect/connection-pooling#connection-pooling) to increase your concurrent connection limit.
</Tip>
...
This query only considers your `max_connections` setting. It does not account for [connection pooling](/connect/connection-pooling#connection-pooling).
...
<Note>
Data size does not include the [history](/reference/glossary#history) that is maintained in Neon to support features like instant restore.
</Note>
