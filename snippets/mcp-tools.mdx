...
- `create_branch`: Creates a new branch within a specified Neon project. Leverages [Neon's branching](/introduction/branching) feature for development, testing, or migrations.
