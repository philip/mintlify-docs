<Prompt description="Copy this prompt into your AI coding assistant (Cursor, Copilot, etc.) to get help creating your first API key and making your first successful API call (using curl, the TypeScript SDK, or the Python SDK).">
