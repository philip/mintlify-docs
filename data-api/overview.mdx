...
<CardGroup>
  ...
  <Card title="Get Started" icon="todo" href="/data-api/get-started">
    Learn how to enable and use the Neon Data API with step-by-step instructions.
  </Card>

  <Card title="Tutorial" icon="audio-jack" href="/data-api/demo">
    Explore our demo note-taking app to learn Data API queries with RLS.
  </Card>

  <Card title="Neon Auth & Data API TypeScript SDKs" icon="code" href="/reference/javascript-sdk">
    Complete reference for authentication and database query methods.
  </Card>

  <Card title="SQL to REST Converter" icon="sql" href="/data-api/sql-to-rest">
    Convert SQL queries into RESTful HTTP requests.
  </Card>

  <Card title="Generate Types" icon="code" href="/data-api/generate-types">
