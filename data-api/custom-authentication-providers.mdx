...
<a href="/data-api/get-started">Getting started with Data API</a>
    <a href="/data-api/access-control">Access control & security</a>
    <a href="/guides/rls-tutorial">Secure your app with RLS</a>
  **Source code**

<a href="https://github.com/neondatabase/pg_session_jwt">pg_session_jwt extension</a>

The Data API works with any authentication provider that issues [JSON Web Tokens (JWTs)](https://jwt.io/introduction). While [Neon Auth](/auth/overview) provides the simplest setup, you can use existing authentication infrastructure with providers like Auth0, Clerk, AWS Cognito, and others.
...
4. The Data API enforces [Row-Level Security policies](/guides/neon-rls) based on the user identity in the JWT.
...
![Find your Auth0 domain for JWKS URL](/images/docs/guides/auth0_neon_jwt.png)
...
![Find your AWS Cognito JWKS URL](/images/docs/guides/aws_cognito_user_pool.png)
...
![Find your Descope Project ID](/images/docs/guides/descope_project_id.png)
...
![Firebase Project ID](/images/docs/guides/firebase_project_id.png)
...
![PropelAuth Auth URL](/images/docs/guides/propelauth_backend_integration_page.png)
...
![SuperTokens Dashboard](/images/docs/guides/supertokens_dashboard.png)
...
![WorkOS Overview Page](/images/docs/guides/workos_overview_page.png)
...
Then set up [Row-Level Security policies](/data-api/get-started#create-a-table-with-rls) to control data access using the `auth.user_id()` function, which extracts the user ID from your JWT.
