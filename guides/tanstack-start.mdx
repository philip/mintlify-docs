...
import TanstackStartPrompt from '/snippets/prompts/tanstack-start-prompt.mdx';
...
<CardGroup>
  ...
  <Card title="Get started with TanStack Start Server Functions and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-tanstack-start-server-functions">
    Get started with TanStack Start Server Functions and Neon
  </Card>

  <Card title="Get started with TanStack Start Static Server Functions and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-tanstack-start-static-server-functions">
