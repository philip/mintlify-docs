...
![edit table records](/images/docs/manage/edit_record_drizzle.png)

## Add records

Add new records to your tables using the **Add record** button.

![add record to table](/images/docs/manage/add_record_drizzle.png)
...
![toggle columns in table view](/images/docs/manage/toggle_columns_drizzle.gif)
...
![add filter to table view](/images/docs/manage/filter_drizzle.gif)

Each new filter is added as a **View** under your list of Tables.

![view filter views under tables](/images/docs/manage/view_filters_drizzle.gif)
...
![delete record from table](/images/docs/manage/delete_record_drizzle.png)
...
![export data from table](/images/docs/manage/export_drizzle.png)
...
![Drizzle Studio Schema Management UI](/images/docs/changelog/drizzle_schema_mgmt.png)
...
![Create roles on the tables page](/images/docs/changelog/tables_page_create_roles.png)

> Neon role and privilege limitations apply. See [Manage roles](/manage/roles).

## Add privileges

For more advanced privilege assignments, click the **Add privilege** link when creating a role to build your `GRANT` statements.

![Add privileges on the tables page](/images/docs/changelog/tables_page_add_privileges.png)
...
![Set RLS policies on the tables page](/images/docs/changelog/tables_page_rls_policies.png)
...
![Select database studio view](/images/docs/changelog/tables_page_select_studio_view.png)

Use the top navbar to navigate:

![Studio view](/images/docs/changelog/tables_page_studio_view.png)
...
Please refer to [DNS resolution issues](/connect/connection-errors#dns-resolution-issues) for workarounds.
