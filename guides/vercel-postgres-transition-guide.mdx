...
- [What changed in your setup](#what-changed-for-you)
- [How billing and plans are affected](#billing-and-plans)
- [What new features you can access](#new-features-available)
- [Technical compatibility information](#compatibility-notes)
</Card>
<Card title="Related topics">
- [Vercel-Managed Integration](/guides/vercel-managed-integration)
- [Migrate from Vercel SDK to Neon](/guides/vercel-sdk-migration)
</Card>
</CardGroup>
...
<Tip title="Upgrade to unlock features">
Pro Plan users can stay on legacy limits or upgrade to a Neon plan to access branching, instant restore, and higher limits. [See how to upgrade](/guides/vercel-managed-integration#changing-your-plan).
</Tip>
...
- **CLI support** - Full [Neon CLI](/reference/neon-cli) (Vercel CLI didn't support Postgres)
- **Terraform support** - [Neon Terraform provider](/reference/terraform)
...
- **[Organization accounts](/manage/organizations)** - Team and project management
- **[Monitoring](/introduction/monitoring-page)** - Database monitoring from Neon Console

### Advanced features (Neon plan required)

- **[Database branching](/guides/branching-intro)** - Branch your database like Git
- **[Instant restore](/guides/branch-restore)** - Point-in-time recovery (was disabled in Vercel Postgres)
- **[Autoscaling](/introduction/autoscaling)** - Automatic performance scaling
- **[Scale to zero](/introduction/scale-to-zero)** - Cost-saving idle scaling
- **[Read replicas](/introduction/read-replicas)** - Offload read queries
- **[Time Travel](/guides/time-travel-assist)** - Query historical data
- **[Protected branches](/guides/protected-branches)** - Protect production data
- **[Schema Diff](/guides/schema-diff)** - Compare schema changes between branches
- **[Logical Replication](/guides/logical-replication-guide)** - Replicate data to and from Neon
- **[IP Allow](/introduction/ip-allow)** - Limit access to trusted IP addresses
- **[Neon GitHub Integration](/guides/neon-github-integration)** - Connect projects to GitHub repos
...
- **Existing templates**: [Environment variables](/guides/vercel-managed-integration#environment-variables-set-by-the-integration) used by Vercel Postgres templates continue to work
...
- **Explore the Neon Console** — Click "Open in Neon" from your Vercel Storage tab to see advanced features [Learn more](#new-features-available)
- **Consider upgrading your plan** — Unlock branching, instant restore, and higher limits with Neon plans [Learn more](#billing-and-plans)
- **Plan SDK migration** — Review migration options for the Vercel SDK to avoid future compatibility issues [Learn more](#compatibility-notes)
- **Test new features** — Try database branching for development environments [Learn more](#new-features-available)
