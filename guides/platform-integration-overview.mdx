...
<CardGroup>
  ...
  <Card title="Agent plan" icon="database" href="/introduction/agent-plan">
    Learn about the Neon Agent plan and how to enroll
  </Card>

  <Card title="AI Agent integration guide" icon="openai" href="/guides/ai-agent-integration">
    Learn about the agent-specific integration
  </Card>

  <Card title="Database versioning" icon="branching" href="/ai/ai-database-versioning">
...
<CardGroup>
  ...
  <Card title="Claimable database guide" icon="import" href="/workflows/claimable-database-integration">
    Learn how to implement claimable databases
  </Card>

  <Card title="Instagres documentation" icon="transactions" href="/reference/instagres">
...
<CardGroup>
  ...
  <Card title="Embedded Postgres guide" icon="import" href="/guides/embedded-postgres">
...
<CardGroup>
  ...
  <Card title="OAuth integration guide" icon="check" href="/guides/oauth-integration">
    Learn how to integrate with Neon using OAuth
  </Card>

  <Card title="Example OAuth app" icon="github" href="https://github.com/neondatabase/neon-branches-visualizer">
...
<CardGroup>
  ...
  <Card title="Talk to our team" icon="todo" href="/contact-sales">
    Schedule a meeting with our team
  </Card>

  <Card title="Contact support" icon="discord" href="/introduction/support">
