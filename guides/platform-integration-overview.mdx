...
<CardGroup>
  ...
  <Card title="Agent plan" icon="/images/technology-logos/database.svg" href="/introduction/agent-plan">
    Learn about the Neon Agent plan and how to enroll
  </Card>

  <Card title="AI Agent integration guide" icon="/images/icons/openai.svg" href="/guides/ai-agent-integration">
    Learn about the agent-specific integration
  </Card>

  <Card title="Database versioning" icon="/images/icons/branching.svg" href="/ai/ai-database-versioning">
...
<CardGroup>
  ...
  <Card title="Claimable database guide" icon="/images/icons/import.svg" href="/workflows/claimable-database-integration">
    Learn how to implement claimable databases
  </Card>

  <Card title="Instagres documentation" icon="/images/icons/transactions.svg" href="/reference/instagres">
...
<CardGroup>
  ...
  <Card title="Embedded Postgres guide" icon="/images/icons/import.svg" href="/guides/embedded-postgres">
...
<CardGroup>
  ...
  <Card title="OAuth integration guide" icon="/images/icons/check.svg" href="/guides/oauth-integration">
    Learn how to integrate with Neon using OAuth
  </Card>

  <Card title="Example OAuth app" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/neon-branches-visualizer">
...
<CardGroup>
  ...
  <Card title="Talk to our team" icon="/images/icons/todo.svg" href="/contact-sales">
    Schedule a meeting with our team
  </Card>

  <Card title="Contact support" icon="/images/icons/discord.svg" href="/introduction/support">
