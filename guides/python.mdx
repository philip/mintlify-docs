...
import PythonPrompt from '/snippets/prompts/python-prompt.mdx';
...
- [Connect an SQLAlchemy application to Neon](/guides/sqlalchemy)
- [Connect a Django application to Neon](/guides/django)
...
<CardGroup>
  ...
  <Card title="Get started with Python and Neon using psycopg (v3)" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-python-psycopg">
    Get started with Python and Neon using psycopg (v3)
  </Card>

  <Card title="Get started with Python and Neon using psycopg2" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-python-psycopg2">
    Get started with Python and Neon using psycopg2
  </Card>

  <Card title="Get started with Python and Neon using asyncpg" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-python-asyncpg">
