...
<CardGroup>
  ...
  <Card title="Get started with Python and Neon using psycopg (v3)" icon="github" href="https://github.com/neondatabase/examples/tree/main/with-python-psycopg">
    Get started with Python and Neon using psycopg (v3)
  </Card>

  <Card title="Get started with Python and Neon using psycopg2" icon="github" href="https://github.com/neondatabase/examples/tree/main/with-python-psycopg2">
    Get started with Python and Neon using psycopg2
  </Card>

  <Card title="Get started with Python and Neon using asyncpg" icon="github" href="https://github.com/neondatabase/examples/tree/main/with-python-asyncpg">
