...
3.  Under **API Keys**, note your **Public Key**, **Private Key**, and **URL Endpoint**. These are essential for interacting with the ImageKit API and SDKs.
    ![ImageKit API Keys](/images/docs/guides/imagekit-api-keys.png)
...
1.  Connect to your Neon database using the [Neon SQL Editor](/get-started/query-with-neon-sql-editor) or a client like [psql](/connect/query-with-psql-editor). Create a table to store relevant details:
