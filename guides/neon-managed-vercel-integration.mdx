...
- [The purpose of the Neon-Managed Integration](#about-this-integration)
- [How to install it from Connectable Accounts](#installation-steps)
- [How automated Preview Branching works](#how-preview-branching-works)
- [How to manage environment variables and branch cleanup](#managing-the-integration)
</Card>
<Card title="Related topics">
- [Vercel-Managed Integration](/guides/vercel-managed-integration)
- [Manual Connections](/guides/vercel-manual)
</Card>
</CardGroup>
...
<Note title="Who should use this integration?">
...
![Install on Existing Neon Account](/images/docs/guides/vercel_install_neon_modal_existing_account.png)
...
![Add Neon from Connectable Accounts](/images/docs/guides/vercel_add_connected_neon_account.png)
</Tip>
...
![Connect Neon Account Projects](/images/docs/guides/vercel_connect_neon_account_projects.png)
...
1. **Select your Vercel project**
   ...
   ![Select a Vercel project](/images/docs/guides/vercel_select_project.png)

2. **Choose your Neon project, database, and role**

   ![Connect to Neon](/images/docs/guides/vercel_connect_neon.png)
...
![Confirm integration settings](/images/docs/guides/vercel_confirm_settings.png)

![Vercel integration success](/images/docs/guides/vercel_success.png)
...
![Neon branches](/images/docs/guides/vercel_neon_branches.png)

**In Vercel:**

- `DATABASE_URL` and other environment variables under **Settings → Environment Variables**

![Vercel environment variables](/images/docs/guides/vercel_env_variables.png)
...
![Vercel build commands](/images/docs/guides/vercel_build_command.png)

![Neon preview deployment branch](/images/docs/guides/vercel_deployments.png)

![Neon preview deployment branch](/images/docs/guides/vercel_neon_app_update.png)

![Vercel preview settings](/images/docs/guides/vercel_preview_settings.png)
...
![Select Vercel variables](/images/docs/guides/vercel_select_variables.png)
...
<Note>
This Git-branch-based cleanup differs from the [Vercel-Managed Integration](/guides/vercel-managed-integration), which deletes branches when deployments are deleted (either manually or automatically via Vercel's retention policies).
...
<Warning title="Important cleanup considerations">
...
- **Test preview branching** — Create a feature branch and push changes to verify preview deployments work correctly [Learn more](#how-preview-branching-works)
- **Configure build commands** — Add migration commands to Vercel's build settings if using an ORM like Prisma [Learn more](#how-preview-branching-works)
- **Set up branch cleanup** — Enable automatic cleanup or establish a manual cleanup process [Learn more](#branch-cleanup)
- **Customize environment variables** — Review and adjust which database variables are injected into your deployments [Learn more](#environment-variables)
