...
1.  Create a new Neon project from the [Neon Console](https://console.neon.tech). For instructions, see [Create a project](/manage/projects#create-a-project).
    <Tip>
...
2.  Navigate to your project dashboard page and copy your database connection string by clicking the **Connect** button.
    ...
    ![Connection modal](/images/docs/connect/connection_details_without_connection_pooling.png)
...
![Medusa Admin Registration](/images/docs/guides/medusa-admin-registration.png)
...
![Medusa Tables in Neon](/images/docs/guides/medusa-neon-tables.png)
...
You can optionally enable IP whitelisting in the Neon Console to restrict database access to only your Medusa server's IP address for enhanced security. Learn more: [Neon IP Allow](/introduction/ip-allow)
