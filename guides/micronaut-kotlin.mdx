...
import MicronautKotlinPrompt from '/snippets/prompts/micronaut-kotlin-prompt.mdx';

<MicronautKotlinPrompt />
...
<CardGroup>
  ...
  <Card title="Get started with Micronaut Kotlin and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-micronaut-kotlin">
