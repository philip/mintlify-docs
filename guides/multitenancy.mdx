...
![Database-per-user](/images/docs/use-cases/database_per_user.png)
...
![Schema-per-user](/images/docs/use-cases/schema_per_user.png)
...
![Shared schema](/images/docs/use-cases/shared_schema.png)
...
![Project per user](/images/docs/use-cases/project_per_user.png)

We recommend setting up one project per user, rather than, for example, using a branch per customer. A Neon [project](/manage/overview) serves as the logical equivalent of an "instance" but without the management overhead. Here's why we suggest this design:
...
- **Per-customer PITR**  
  Setting up a project per customer allows you to run [PITR on individual customers](/guides/branch-restore) instantly, without risking disruption to your entire fleet.
...
- **You only pay for active projects**  
  Empty projects are virtually free thanks to Neon's [scale-to-zero](/guides/auto-suspend-guide) feature. If, on a given day, you have a few hundred projects that were only active for a few minutes, that's fine; your bill won't suffer.
...
![catalog database](/images/docs/use-cases/catalog_database.png)
...
- **Automated backups to your own S3**  
  If you must keep your own data copy, you can [schedule regular backups](/manage/backups-aws-s3-backup-part-2) using tools like `pg_dump` in conjunction with GitHub Actions.
...
![shared application environments](/images/docs/use-cases/shared_application_environments.png)
...
![isolated application environments](/images/docs/use-cases/isolated_application_environments.png)
...
![S3 backup IAM configuration](/images/docs/use-cases/s3_backup_iam_config.png)
...
![S3 backup select trusted entity](/images/docs/use-cases/s3_select_trusted_entity.png)
...
![S3 backup web identity](/images/docs/use-cases/s3_web_identity.png)
...
![S3 backup three databases](/images/docs/use-cases/s3_backup_three_databases.png)
...
![S3 backup three databases](/images/docs/use-cases/github_secrets.png)
