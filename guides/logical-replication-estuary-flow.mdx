...
3. Enter the connection details for your Neon database. You can find your Neon database connection details by clicking the **Connect** button on your **Project Dashboard** to open the **Connect to your database** modal.
   ...
   ![Creating a Neon capture connector in Estuary Flow](/images/docs/guides/estuary_flow_create_neon_capture.png)
   ...
   ![Configuring Neon capture in Estuary Flow](/images/docs/guides/estuary_flow_configure_neon_capture.png)
...
4. Click **Next**. Estuary Flow will now scan the source database for all the tables that can be replicated. Select one or more tables by checking the checkbox next to their name.
   ...
   ![Selecting collections for replication in Estuary Flow](/images/docs/guides/estuary_flow_configure_collections.png)
...
![Preview data in Estuary Flow](/images/docs/guides/estuary_flow_preview_collections.png)
