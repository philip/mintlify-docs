...
<a href="/guides/branching-neon-cli">Branching with the Neon CLI</a>
<a href="/manage/branches#branching-with-the-neon-api">Branching with the Neon API</a>
<a href="/manage/branches">Manage branches</a>
<a href="/introduction/branching#branching-workflows">Branching workflows</a>
...
- **Data API**
- **[Legacy Neon Auth](/auth/legacy/overview)** (the new [Neon Auth](/auth/overview) is supported)
...
![Set branch expiration](/images/docs/changelog/branch_expiration_presets.png)
...
![Update branch expiration](/images/docs/guides/branch-update-set-expiration.png)
...
![View branch expiration](/images/docs/guides/branch-view-expiration.png)
