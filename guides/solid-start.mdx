...
import SolidstartPrompt from '/snippets/prompts/solidstart-prompt.mdx';
...
<CardGroup>
  ...
  <Card title="Get started with SolidStart and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-solid-start">
