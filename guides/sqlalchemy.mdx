...
import SqlalchemyPrompt from '/snippets/prompts/sqlalchemy-prompt.mdx';
...
You can find the connection details for your database by clicking the **Connect** button on your **Project Dashboard**. For more information, see [Connect from any application](/connect/connect-from-any-app).
...
<a href="/guides/sqlalchemy-migrations" description="Schema migration with Neon Postgres and SQLAlchemy" icon="/images/icons/app-store.svg">SQLAlchemy Migrations</a>
