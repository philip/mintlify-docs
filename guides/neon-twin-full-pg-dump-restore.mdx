...
<Note>
To use this workflow, you'll need the Postgres connection string for your Neon database. Follow our [Getting Started Guide](/get-started/signing-up#sign-up) to learn how.
</Note>
...
![github repository secrects](/images/docs/guides/twin_diagram_github_secrets.png)
...
![github actions run workflow](/images/docs/guides/twin_diagram_test_workflow.png)
