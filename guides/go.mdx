...
import GolangPrompt from '/snippets/prompts/golang-prompt.mdx';
...
<CardGroup>
  ...
  <Card title="Get started with Go and Neon using pgx" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-golang">
    Get started with Go and Neon using pgx
  </Card>
