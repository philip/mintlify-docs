...
The easiest way to get started is with the [Neon GitHub integration](/guides/neon-github-integration). It connects your Neon project to a GitHub repository, automatically creating the necessary `NEON_API_KEY` secret and `NEON_PROJECT_ID` variable for you. If you use the integration, you can skip the manual setup steps below.

### Manually set up your repository

1.  **Create a Neon API key.** For instructions, see [Create an API key](/manage/api-keys#create-an-api-key).
...
6.  You will also need your Neon **Project ID**, which you can find in the **Settings** page of the Neon console.
    ![Neon Project ID in the console](/images/docs/manage/settings_page.png)
...
<CardGroup>
  ...
  <Card title="Create branch action" icon="/images/technology-logos/github.svg" href="https://github.com/marketplace/actions/neon-create-branch-github-action">
    Creates a new database branch. Ideal for setting up isolated environments for preview deployments or feature testing.
  </Card>

  <Card title="Delete branch action" icon="/images/technology-logos/github.svg" href="https://github.com/marketplace/actions/neon-database-delete-branch">
    Deletes a specified database branch. Use this to clean up ephemeral branches after a pull request is merged or closed.
  </Card>

  <Card title="Reset branch action" icon="/images/technology-logos/github.svg" href="https://github.com/marketplace/actions/neon-database-reset-branch-action">
    Resets a branch to the latest state of its parent. Useful for refreshing a development branch with production data.
  </Card>

  <Card title="Schema diff action" icon="/images/technology-logos/github.svg" href="https://github.com/marketplace/actions/neon-schema-diff-github-action">
