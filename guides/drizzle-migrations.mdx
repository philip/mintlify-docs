...
The generated migration file is written in SQL and contains the necessary commands to create the tables in the database. To apply these migrations, we'll use the [Neon serverless driver](/serverless/serverless-driver) and helper functions provided by the `drizzle-orm` library.
...
<CardGroup>
  ...
  <Card title="Migrations with Neon and Drizzle" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/guide-neon-drizzle">
