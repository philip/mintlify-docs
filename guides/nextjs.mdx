...
<CardGroup>
  ...
  <Card title="Get started with Next.js Edge Functions and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-nextjs-edge-functions">
    Get started with Next.js Edge Functions and Neon
  </Card>

  <Card title="Get started with Next.js Serverless Functions and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-nextjs-serverless-functions">
    Get started with Next.js Serverless Functions and Neon
  </Card>

  <Card title="Get started with Next.js getServerSideProps and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-nextjs-get-server-side-props">
    Get started with Next.js getServerSideProps and Neon
  </Card>

  <Card title="Get started with Next.js getStaticProps and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-nextjs-get-static-props">
    Get started with Next.js getStaticProps and Neon
  </Card>

  <Card title="Get started with Next.js Server Actions and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-nextjs-server-actions">
    Get started with Next.js Server Actions and Neon
  </Card>

  <Card title="Get started with Next.js Server Components and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-nextjs-server-components">
