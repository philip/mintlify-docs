...
1. **Create a Neon API Key.**
   ...
   - Create a new API key and copy it. See [Manage API keys](/manage/api-keys) for more information.
...
<CardGroup>
  ...
  <Card title="Get started with Encore and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-encore">
    Encore.ts application with Neon Postgres
  </Card>
