...
import NestjsPrompt from '/snippets/prompts/nestjs-prompt.mdx';
...
<CardGroup>
  ...
  <Card title="Get started with NestJS and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-nestjs">
