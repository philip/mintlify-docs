...
<a href="/data-api/get-started">Data API</a>
  <a href="/guides/rls-drizzle">Simplify RLS with Drizzle</a>
...
<CardGroup>
  ...
  <Card title="Get started" icon="database" href="/data-api/get-started">
    Learn how to enable and use the Data API with RLS policies
  </Card>

  <Card title="Building a note-taking app" icon="github" href="/data-api/demo">
...
<CardGroup>
  ...
  <Card title="Simplify RLS with Drizzle" icon="drizzle" href="/guides/rls-drizzle">
...
<CardGroup>
  ...
  <Card title="Postgres RLS Tutorial" icon="database" href="/postgresql/postgresql-administration/postgresql-row-level-security">
