...
import PrismaPrompt from '/snippets/prompts/prisma-prompt.mdx';
...
<Tip>
If you just need to connect Prisma to Neon without a full tutorial, see [Connect from Prisma to Neon](/guides/prisma).
</Tip>

## Prerequisites

- A [Neon account and project](/get-started-with-neon/signing-up)
...
<CardGroup>
  ...
  <Card title="Migrations with Neon and Prisma" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/guide-neon-prisma">
...
- [Connect from Prisma to Neon](/guides/prisma): Connection setup reference
...
- [Neon branching](/introduction/branching): Use database branches to test migrations safely
