...
<CardGroup>
  ...
  <Card title="View live demo" icon="openai" href="https://neon-experimental.vercel.app">
    Try the live demo application
  </Card>

  <Card title="View on GitHub" icon="github" href="https://github.com/neondatabase/neon-branches-visualizer">
