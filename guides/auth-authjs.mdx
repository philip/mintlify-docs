...
To apply this schema to your Neon database, you can use the [Neon SQL Editor](/get-started/query-with-neon-sql-editor) in the web console or a database management tool like [psql](/connect/query-with-psql-editor).
...
<CardGroup>
  ...
  <Card title="Authentication flow with Auth.js" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/auth/with-authjs-next">
