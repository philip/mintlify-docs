...
import ElixirPrompt from '/snippets/prompts/elixir-prompt.mdx';
...
3.  Select the **Parameters only** tab to view the connection string parameters.
    ![Connection modal](/images/docs/connect/connection_details_parameters_only.png)
...
- [Connect an Elixir Ecto application to Neon](/guides/elixir-ecto)
...
<CardGroup>
  ...
  <Card title="Get started with Elixir and Neon using Postgrex" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with_elixir_postgrex">
    Get started with Elixir and Neon using Postgrex
  </Card>
