...
<CardGroup>
  ...
  <Card title="Authentication flow with Okta" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/guide-neon-next-okta">
