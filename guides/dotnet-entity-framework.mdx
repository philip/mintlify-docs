...
import DotnetEfPrompt from '/snippets/prompts/dotnet-ef-prompt.mdx';
...
<CardGroup>
  ...
  <Card title="Get started with Entity Framework and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-dotnet-entity-framework">
