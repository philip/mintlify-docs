...
2. Go to AskYourDatabase and click **Connect to your database**:
   ![Connect to new db](/images/docs/guides/askyourdatabase_connect_neon_1.png)

3. Select PostgreSQL as your database type, and paste your connection string:

   ![Paste connection string](/images/docs/guides/askyourdatabase_connect_neon_2.png)

4. A new chat session opens if the connection is successful:

   ![New chat session](/images/docs/guides/askyourdatabase_connect_neon_3.png)
...
![Chat with Neon](/images/docs/guides/askyourdatabase_ask_neon.png)
