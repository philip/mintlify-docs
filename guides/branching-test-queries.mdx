...
3. Click **Create branch** to open the branch creation dialog.
   ![Create branch dialog](/images/docs/manage/create_branch.png)
...
You can also create a test branch using the [Neon CLI](/reference/cli-branches#create) or [Neon API](/manage/branches#create-a-branch-with-the-api).
...
You can also delete a branch using the [Neon CLI](/reference/cli-branches#delete) or [Neon API](/manage/branches#delete-a-branch-with-the-api).
