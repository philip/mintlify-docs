...
description: >-
  Step-by-step guide for connecting a Nuxt application to a Postgres database on
  Neon, including project creation, dependency installation, and configuration
  of connection settings.
---

import NuxtNeonPrompt from '/snippets/prompts/nuxt-neon-prompt.mdx';
...
<CardGroup>
  ...
  <Card title="Get started with Nuxt and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-nuxt">
