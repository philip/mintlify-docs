...
<CardGroup>
  ...
  <Card title="Automated Database Branching with GitHub Actions" icon="github" href="/guides/neon-github-actions-authomated-branching">
    Learn how to automate database branching for your application using Neon and GitHub Actions
  </Card>

  <Card title="Preview branches with Cloudflare Pages" icon="github" href="https://github.com/neondatabase/preview-branches-with-cloudflare">
  ...
  <Card title="Neon Twitter app" icon="github" href="https://github.com/neondatabase/neon_twitter">
