...
import RedwoodSdkPrompt from '/snippets/prompts/redwood-sdk-prompt.mdx';
...
<CardGroup>
  ...
  <Card title="Get started with RedwoodSDK and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-redwoodsdk">
