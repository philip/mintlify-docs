...
![trigger serverless functions with inngest](/images/docs/guides/inngest.jpg)
...
- Creating a Neon project and enabling [Logical Replication](/guides/logical-replication-guide).
...
- A Neon account. If you do not have one, see [Sign up](/get-started/signing-up) for instructions.
...
![Neon dashboard settings with option to enable logical replication](/images/docs/guides/neon-console-settings-logical-replication.png)
...
![Neon integration card inside the Inngest integrations page](/images/docs/guides/inngest-integrations-page.png)
...
![Neon authorization step inside the Inngest integrations page](/images/docs/guides/inngest-integration-neon-authorize-step.png)
...
![You can add a new record to the users table directly from the Neon console](/images/docs/guides/inngest-integration-neon-console-users-table-add-new-record.png)
...
![The Inngest Platform lists all the runs](/images/docs/guides/inngest-integrations-inngest-platform-new-runs.png)
