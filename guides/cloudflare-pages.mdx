...
We'll use the [Neon serverless driver](/serverless/serverless-driver) to connect to the database and make queries.
...
We'll use the [Neon serverless driver](/serverless/serverless-driver) to connect to the Neon database, so we first need to install it as a dependency:
...
<CardGroup>
  ...
  <Card title="Use Neon with Cloudflare Pages" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/deploy-with-cloudflare-pages">
