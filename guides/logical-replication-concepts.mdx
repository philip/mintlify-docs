...
<Note>
For step-by-step setup instructions, refer to our [logical replication guides](/guides/logical-replication-guide).
</Note>
...
![Logical replication publisher subscriber architecture](/images/docs/guides/logical_replication_model.jpg)
...
<Warning>
To prevent storage bloat, **Neon automatically removes _inactive_ replication slots after a period of time. Please see [Unused replication slots](/guides/logical-replication-neon#unused-replication-slots) to learn more.
</Warning>
