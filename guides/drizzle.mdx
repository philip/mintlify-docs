...
import DrizzlePrompt from '/snippets/prompts/drizzle-prompt.mdx';
...
<a href="https://orm.drizzle.team/docs/tutorials/drizzle-with-neon">Drizzle with Neon Postgres (Drizzle Docs)</a>
  <a href="/guides/drizzle-migrations">Schema migration with Drizzle ORM</a>
...
Working with AI coding assistants? Check out our [AI rules for Drizzle ORM with Neon](/ai/ai-rules-neon-drizzle) to help your AI assistant generate better code when using Drizzle with your Neon database.
</Tip>
...
<Tab title="Neon Serverless (HTTP)">
...
<Tab title="Neon WebSocket / node-postgres / postgres.js">
