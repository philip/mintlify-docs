...
import KyselyPrompt from '/snippets/prompts/kysely-prompt.mdx';
...
Navigate to the [SQL Editor in the Neon Console](/get-started/query-with-neon-sql-editor) and run the following SQL command to create a `users` table:
