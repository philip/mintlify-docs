...
<Note>
In Prisma 7, you must use a driver adapter since the `url` property is no longer supported in the schema file. See [Connect from Prisma to Neon](/guides/prisma) for complete setup instructions.
</Note>
