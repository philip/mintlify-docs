...
![show wal_level](/images/docs/guides/alloydb_show_wal_level.png)
...
5. Under **Authorized external networks**, enter the Neon IP addresses you want to allow. Add an entry for each of the NAT gateway IP addresses associated with your Neon project's region. Neon has 3 to 6 IP addresses per region, corresponding to each availability zone. See [NAT Gateway IP addresses](/introduction/regions#nat-gateway-ip-addresses) for the IP addresses.
   ...
   ![AlloyDB network configuration](/images/docs/guides/alloydb_network_config.png)
...
![AlloyDB public IP address](/images/docs/guides/alloydb_public_ip.png)
