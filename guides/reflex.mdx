...
import ReflexPrompt from '/snippets/prompts/reflex-prompt.mdx';
...
You can find the connection string for your database by clicking the **Connect** button on your **Project Dashboard** in the Neon Console. For more information, see [Connect from any application](/connect/connect-from-any-app).
...
To create a data model in Reflex, you can define a Python class that represents the data structure. Reflex uses [sqlmodel](https://sqlmodel.tiangolo.com/) to provide a built-in ORM wrapping [SQLAlchemy](/guides/sqlalchemy).
...
![Reflex Customer Data App](/images/docs/guides/reflex_customer_data_app.png)
...
<CardGroup>
  ...
  <Card title="Customer Data App" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/reflex/with_reflex">
