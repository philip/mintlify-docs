...
import HonoPrompt from '/snippets/prompts/hono-prompt.mdx';
...
<CardGroup>
  ...
  <Card title="Get started with Hono and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-hono">
