...
<CardGroup>
  ...
  <Card title="Azure PostgreSQL" icon="azure" href="/import/migrate-from-azure-postgres">
  ...
  <Card title="RDS" icon="aws-rds" href="/guides/logical-replication-rds-to-neon">
    Replicate data from AWS RDS PostgreSQL to Neon
  </Card>

  <Card title="Supabase" icon="supabase" href="/guides/logical-replication-supabase-to-neon">
