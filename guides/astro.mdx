...
<CardGroup>
  ...
  <Card title="Get started with Astro and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-astro">
    Get started with Astro and Neon
  </Card>

  <Card title="Get started with Astro API Routes and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-astro-api-routes">
