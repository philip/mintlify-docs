...
- A [restore window](/introduction/restore-window) that covers the timeframe of interest, allowing for effective use of Time Travel.
...
![select timestamp](/images/docs/guides/time_travel_tutorial_activation.png)
...
1. Enter a time period just before the identified activation timestamp.
   ...
   ![check pre-activation](/images/docs/guides/time_travel_tutorial_before.png)
...
![check post-activation](/images/docs/guides/time_travel_tutorial_after.png)
