...
import SveltekitPrompt from '/snippets/prompts/sveltekit-prompt.mdx';
...
<CardGroup>
  ...
  <Card title="Get started with Sveltekit and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-sveltekit">
