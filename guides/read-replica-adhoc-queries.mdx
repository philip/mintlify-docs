...
- The read replica compute automatically scales to zero based on your [scale to zero](/introduction/scale-to-zero) settings. A compute suspends due to inactivity after 5 minutes of inactivity.
...
Alternatively, you can create read replicas using the [Neon CLI](/reference/cli-branches#create) or [Neon API](https://api-docs.neon.tech/reference/createprojectendpoint).
