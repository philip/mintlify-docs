...
import DjangoPrompt from '/snippets/prompts/django-prompt.mdx';
...
- If you encounter an `SSL SYSCALL error: EOF detected` when connecting to the database, this typically occurs because the application is trying to reuse a connection after the Neon compute has been suspended due to inactivity. To resolve this issue, try one of the following options:
  ...
  For information configuring Neon's Scale to zero setting, see [Configuring Scale to zero for Neon computes](/guides/scale-to-zero-guide).
...
<a href="/guides/django-migrations" description="Schema migration with Neon Postgres and Django" icon="/images/icons/app-store.svg">Django Migrations</a>
...
<CardGroup>
  ...
  <Card title="Blog Post: Using Django with Neon" icon="/images/icons/import.svg" href="/blog/python-django-and-neons-serverless-postgres">
    Learn how to build a Django application with Neon Postgres
  </Card>

  <Card title="Django sample application" icon="/images/technology-logos/github.svg" href="https://github.com/evanshortiss/django-neon-quickstart">
