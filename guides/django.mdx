...
<a href="/guides/django-migrations" description="Schema migration with Neon Postgres and Django" icon="app-store" icon="app-store">Django Migrations</a>
...
<CardGroup>
  ...
  <Card title="Blog Post: Using Django with Neon" icon="import" href="/blog/python-django-and-neons-serverless-postgres">
    Learn how to build a Django application with Neon Postgres
  </Card>

  <Card title="Django sample application" icon="github" href="https://github.com/evanshortiss/django-neon-quickstart">
