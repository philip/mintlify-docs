...
import DotnetPrompt from '/snippets/prompts/dotnet-prompt.mdx';
...
3.  Select **.NET** as your connection method.
    ![Connection modal](/images/docs/connect/dotnet_connection_details.png)
...
- [Connect an Entity Framework application to Neon](/guides/dotnet-entity-framework)
...
<CardGroup>
  ...
  <Card title="Get started with .NET (C#) and Neon" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/with-dotnet-npgsql/NeonLibraryExample">
