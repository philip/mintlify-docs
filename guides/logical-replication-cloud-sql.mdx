...
![Clod SQL instance restart](/images/docs/guides/cloud_sql_restart.png)
...
![show wal_level](/images/docs/guides/cloud_sql_show_wal_level.png)
...
1. In the **Network** field, enter the IP address from which you want to allow connections. You will need to perform this step for each of the NAT gateway IP addresses associated with your Neon project's region. Neon uses 3 to 6 IP addresses per region for this outbound communication, corresponding to each availability zone in the region. See [NAT Gateway IP addresses](/introduction/regions#nat-gateway-ip-addresses) for Neon's NAT gateway IP addresses.
   ...
   ![Cloud SQL network configuration](/images/docs/guides/cloud_sql_network_config.png)
...
![Clould SQL public IP address](/images/docs/guides/cloud_sql_public_ip.png)
