...
3.  Click **Create bucket**, provide a unique bucket name (for example, `my-neon-app-files`), and click **Create bucket**.
    ![Create R2 Bucket](/images/docs/guides/cloudflare-r2-create-bucket.png)
...
1.  Connect to your Neon database using the [Neon SQL Editor](/get-started/query-with-neon-sql-editor) or a client like [psql](/connect/query-with-psql-editor). Here is an example SQL statement to create a simple table including the object key, URL, user ID, and timestamp:
