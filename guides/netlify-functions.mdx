...
This guide will show you how to connect to a Neon Postgres database from your Netlify Functions project. We'll use the [Neon serverless driver](/serverless/serverless-driver) to connect to the database and make queries.
...
To remove your Neon project, follow the deletion steps in Neon's documentation under [Manage Projects](/manage/projects#delete-a-project).
...
<CardGroup>
  ...
  <Card title="Use Neon with Netlify Functions" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/deploy-with-netlify-functions">
