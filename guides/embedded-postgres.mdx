...
<Card title="Learn how platforms embed Neon" isIntro>
...
<CardGroup>
  ...
  <Card title="Neon API Reference" icon="transactions" href="/reference/api-reference">
    Explore all available API endpoints
  </Card>

  <Card title="Talk to Sales" icon="todo" href="/contact-sales">
