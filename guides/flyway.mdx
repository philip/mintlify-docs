...
- A database. This guide uses the ready-to-use `neondb` database. You can create your own database if you like. See [Create a database](/manage/databases#create-a-database) for instructions.
...
Learn how you can use Flyway with multiple database environments. See [Use Flyway with multiple database environments](/guides/flyway-multiple-environments).
