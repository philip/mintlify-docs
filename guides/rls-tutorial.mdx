...
- **Neon account**: Sign up at [Neon](https://neon.tech) and create your first project in **AWS** (note: [Azure](/guides/neon-rls#current-limitations) regions are not currently supported).
...
![empty state two users in data api demo](/images/docs/guides/data_api_demo_empty_state.png)
...
![isolated note lists](/images/docs/guides/data_api_demo_isolated_notes.png)

The paragraphs in the notes are:

![paragraphs in notes](/images/docs/guides/data_api_demo_paragraphs_in_notes.png)
...
![isolated notes](/images/docs/guides/data_api_demo_isolated_notes.png)
...
![data leak](/images/docs/guides/data_api_demo_data_leak.png)
...
![isolated notes restored](/images/docs/guides/data_api_demo_isolated_notes.png)
...
To get an understanding of `auth.user_id()` and the role it plays in these policies, see this [explanation](/guides/neon-rls#how-neon-rls-gets-authuserid-from-the-jwt).
