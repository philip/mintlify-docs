...
import ConsumptionApiPrompt from '/snippets/prompts/consumption-api-prompt.mdx';

Using the Neon API, you can query consumption metrics to track your resource usage. This page describes the **project metrics** endpoint, which returns metrics that align with [usage-based billing](/introduction/plans) and match your invoice on usage-based plans.
