...
<CardGroup cols={2}>
<Card title="What you will find on this page">
...
- [Deploy Neon on Azure](/azure/azure-deploy)
</Card>
</CardGroup>
...
<CardGroup>
  ...
  <Card title="Azure CLI: az neon" icon="/images/icons/cli.svg" href="https://learn.microsoft.com/en-us/cli/azure/neon?view=azure-cli-latest">
    Manage your Neon Resource with the Azure CLI
  </Card>

  <Card title="Azure SDK for Java" icon="/images/icons/code.svg" href="https://learn.microsoft.com/en-us/java/api/overview/azure/neonpostgres?view=azure-java-preview">
    Manage your Neon Resource with the Azure SDK for Java
  </Card>

  <Card title="Azure SDK for JavaScript" icon="/images/icons/code.svg" href="https://learn.microsoft.com/en-us/javascript/api/overview/azure/neonpostgres?view=azure-node-preview">
    Manage your Neon Resource with the Azure SDK for JavaScript
  </Card>

  <Card title="Azure SDK for .NET" icon="/images/icons/code.svg" href="https://learn.microsoft.com/en-us/dotnet/api/overview/azure/neonpostgres?view=azure-dotnet-preview">
    Manage your Neon Resource with the Azure SDK for .NET
  </Card>

  <Card title="Azure SDK for Python" icon="/images/icons/code.svg" href="https://learn.microsoft.com/en-us/python/api/overview/azure/neonpostgres?view=azure-python-preview">
    Manage your Neon Resource with the Azure SDK for Python
  </Card>

  <Card title="Powershell" icon="/images/icons/code.svg" href="https://learn.microsoft.com/en-us/dotnet/api/microsoft.azure.powershell.cmdlets.neonpostgres?view=az-ps-latest">
...
<CardGroup>
  ...
  <Card title="Multi-user RAG in Azure" icon="/images/icons/enable.svg" href="https://multiuser-rag-g0e0g3h6ekhtf7cg.germanywestcentral-01.azurewebsites.net/">
    Creates a Neon project with a vector storage per user; each user's data is completely isolated
  </Card>

  <Card title="AI-Powered Neon Database Q&A Chatbot in Azure" icon="/images/icons/enable.svg" href="https://rag-vrjtpx5tgrsnm-ca.wittyriver-637b2279.eastus2.azurecontainerapps.io/">
...
<CardGroup>
  ...
  <Card title="ASP.NET Core Development with Neon Serverless Postgres & Azure" icon="/images/icons/enable.svg" href="https://www.udemy.com/course/aspnet-core-development-with-neon-postgresql-azure">
