...
<CardGroup>
  ...
  <Card title="Neon Auth & Data API TypeScript SDKs" icon="/images/technology-logos/neon.svg" href="/reference/javascript-sdk">
...
<CardGroup>
  ...
  <Card title="Neon API TypeScript SDK" icon="/images/technology-logos/neon.svg" href="/reference/typescript-sdk">
    Programmatically manage Neon projects, branches, databases, and other platform resources
  </Card>

  <Card title="Python SDK (Neon API)" icon="/images/technology-logos/neon.svg" href="/reference/python-sdk">
    Programmatically manage Neon projects, branches, databases, and other platform resources
  </Card>

  <Card title="@neondatabase/toolkit" icon="/images/technology-logos/neon.svg" href="/reference/neondatabase-toolkit">
...
<CardGroup>
  ...
  <Card title="Go SDK (Neon API)" icon="/images/technology-logos/github.svg" href="https://github.com/kislerdm/neon-sdk-go">
    A Go SDK for the Neon API
  </Card>

  <Card title="Node.js / Deno SDK (Neon API)" icon="/images/technology-logos/github.svg" href="https://github.com/paambaati/neon-js-sdk">
