...
Alternatively, you can use a personal Neon API key. You can create one in the Neon Console. See [Create a personal API key](/manage/api-keys#create-a-personal-api-key).
...
For more about authenticating, see [Neon CLI commands — auth](/reference/cli-auth).
...
For more about the `set-context` command, see [Neon CLI commands — set-context](/reference/cli-set-context).
...
Now you can press **Tab** to complete Neon CLI commands and options. For further details, see [Neon CLI commands — completion](/reference/cli-completion).
...
For more about the `projects` command, see [Neon CLI commands — projects](/reference/cli-projects).
...
For more about the `branches` command, see [Neon CLI commands — branches](/reference/cli-branches).
...
There's lots more you can do with the `connection-string` command. See [Neon CLI commands — connection-string](/reference/cli-connection-string).
...
For more details on all available commands, see the [CLI Reference](/reference/neon-cli).
