...
- Before running the `set-context` command, ensure that you have [installed the Neon CLI](/reference/neon-cli#install-the-neon-cli).
...
<Tip title="Context file location">
...
[Global options](/reference/neon-cli#global-options) are also supported.
