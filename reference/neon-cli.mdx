...
🚀 Get set up in just a few steps with the [CLI Quickstart](/reference/cli-quickstart).
...
For more about installing, upgrading, and connecting, see [Neon CLI — Install and connect](/reference/cli-install).

<Note title="Use the Neon CLI without installing">
...
| [orgs](/reference/cli-orgs)                           | `list`                                                                                                       | Manage organizations                                          |
| [projects](/reference/cli-projects)                   | `list`, `create`, `update`, `delete`, `get`                                                                  | Manage projects                                               |
| [ip-allow](/reference/cli-ip-allow)                   | `list`, `add`, `remove`, `reset`                                                                             | Manage IP Allow                                               |
| [vpc](/reference/cli-vpc)                             | `endpoint`, `project`                                                                                        | Manage VPC endpoints and project VPC restrictions             |
| [branches](/reference/cli-branches)                   | `list`, `create`, `reset`, `restore`, `rename`, `schema-diff`, `set-default`, `add-compute`, `delete`, `get` | Manage branches                                               |
...
| [set-context](/reference/cli-set-context)             |                                                                                                              | Set context for session                                       |
| [init](/reference/cli-init)                           |                                                                                                              | Initialize a project with Neon using your AI coding assistant |
...
- <a id="api-key"></a>`--api-key`
  ...
  Specifies your Neon API key. You can authenticate using a Neon API key when running a Neon CLI command instead of using `neon auth`. For information about obtaining an Neon API key, see [Create an API key](/manage/api-keys#create-an-api-key).
...
- <a id="context-file"></a>`--context-file`
  ...
  To define a context file, see [Neon CLI commands — set-context](/reference/cli-set-context).
