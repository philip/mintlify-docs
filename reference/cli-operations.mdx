...
- Before running the `operations` command, ensure that you have [installed the Neon CLI](/reference/cli-install).
...
For information about operations in Neon, see [System operations](/manage/operations).
...
In addition to the Neon CLI [global options](/reference/neon-cli#global-options), the `list` subcommand supports this option:
