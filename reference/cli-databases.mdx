...
- Before running the `databases` command, ensure that you have [installed the Neon CLI](/reference/cli-install).
...
For information about databases in Neon, see [Manage databases](/manage/databases).
...
In addition to the Neon CLI [global options](/reference/neon-cli#global-options), the `delete` subcommand supports these options:
