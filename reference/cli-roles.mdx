...
- Before running the `roles` command, ensure that you have [installed the Neon CLI](/reference/cli-install).
...
For information about roles in Neon, see [Manage roles](/manage/roles).
