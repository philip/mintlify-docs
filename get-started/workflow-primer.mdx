...
<CardGroup>
  ...
  <Card title="Branching with the Neon CLI" icon="github" href="/guides/branching-neon-cli">
    Learn about branching with the Neon CLI
  </Card>

  <Card title="Neon CLI Reference" icon="github" href="/reference/neon-cli">
...
<CardGroup>
  ...
  <Card title="Create branch Action" icon="github" href="https://github.com/neondatabase/create-branch-action">
    Create Neon Branch GitHub Action
  </Card>

  <Card title="Delete Branch Action" icon="github" href="https://github.com/neondatabase/delete-branch-action">
    Delete Neon Branch GitHub Action
  </Card>

  <Card title="Reset Branch Action" icon="github" href="https://github.com/neondatabase/reset-branch-action">
    Reset Neon Branch GitHub Action
  </Card>

  <Card title="Schema Diff Action" icon="github" href="https://github.com/neondatabase/schema-diff-action">
...
<CardGroup>
  ...
  <Card title="Preview branches with Fly.io" icon="github" href="https://github.com/neondatabase/preview-branches-with-fly">
    Sample project showing you how to create a branch for every Fly.io preview deployment
  </Card>

  <Card title="Preview branches with Vercel" icon="github" href="https://github.com/neondatabase/preview-branches-with-vercel">
