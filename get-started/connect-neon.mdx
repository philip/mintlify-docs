...
<CardGroup>
  ...
  <Card title="Connect documentation" icon="network" href="/connect/connect-intro">
    Comprehensive guide to all connection methods, troubleshooting, and security
  </Card>

  <Card title="Framework guides" icon="gamepad" href="/get-started/frameworks">
    Step-by-step guides for Next.js, Remix, Django, Rails, and more
  </Card>

  <Card title="Language guides" icon="code" href="/get-started/languages">
    Connection examples for JavaScript, Python, Go, Rust, and other languages
  </Card>

  <Card title="Serverless driver" icon="audio-jack" href="/serverless/serverless-driver">
