...
<Note>
Neon supports both pooled and direct connections. Use a pooled connection string (with `-pooler` in the hostname) if your application creates many concurrent connections. See [Connection pooling](/connect/connection-pooling) for details.
</Note>
...
<CardGroup>
  ...
  <Card title="Connect documentation" icon="/images/icons/network.svg" href="/connect/connect-intro">
    Comprehensive guide to all connection methods, troubleshooting, and security
  </Card>

  <Card title="Framework guides" icon="/images/icons/gamepad.svg" href="/get-started/frameworks">
    Step-by-step guides for Next.js, Remix, Django, Rails, and more
  </Card>

  <Card title="Language guides" icon="/images/icons/code.svg" href="/get-started/languages">
    Connection examples for JavaScript, Python, Go, Rust, and other languages
  </Card>

  <Card title="Serverless driver" icon="/images/icons/audio-jack.svg" href="/serverless/serverless-driver">
