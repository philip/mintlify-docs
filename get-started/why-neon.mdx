...
<Tip title="A Databricks company">
...
- The experience feels lightweight, fast, and developer-first, not enterprise-heavy
  ...
  <Tip title="Useful links to get started">
    Check out our [framework guides](/get-started/frameworks), [templates](https://neon.com/templates), [code examples](https://github.com/neondatabase/examples), and join our [community Discord](https://discord.gg/92vNTzKDGp).
  </Tip>
...
<Tip title="Join the Agent Program">
...
<Tip title="Keep exploring Lakebase">
...
<Card title="Contact us" href="https://www.databricks.com/company/contact">
