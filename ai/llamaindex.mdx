...
<CardGroup>
  ...
  <Card title="Semantic search chatbot (OpenAI + LlamaIndex)" icon="github" href="https://github.com/neondatabase/examples/tree/main/ai/llamaindex/semantic-search-nextjs">
