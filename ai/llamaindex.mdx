...
<CardGroup>
  ...
  <Card title="Semantic search chatbot (OpenAI + LlamaIndex)" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/ai/llamaindex/semantic-search-nextjs">
