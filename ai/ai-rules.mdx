...
<CardGroup>
  ...
  <Card title="Neon Auth" icon="lock-landscape" href="/ai/ai-rules-neon-auth">
    AI rules for implementing authentication with Neon
  </Card>

  <Card title="Neon Serverless Driver" icon="network" href="/ai/ai-rules-neon-serverless">
    AI rules for serverless database connections
  </Card>

  <Card title="Neon Drizzle" icon="drizzle" href="/ai/ai-rules-neon-drizzle">
    AI rules for using Drizzle ORM with Neon
  </Card>

  <Card title="Neon API TypeScript SDK" icon="code" href="/ai/ai-rules-neon-typescript-sdk">
    AI rules for using the Neon API TypeScript SDK
  </Card>

  <Card title="Neon Python SDK" icon="code" href="/ai/ai-rules-neon-python-sdk">
    AI rules for using the Neon Python SDK
  </Card>

  <Card title="Neon API" icon="code" href="/ai/ai-rules-neon-api">
    AI rules for using the Neon API
  </Card>

  <Card title="Neon Toolkit" icon="database" href="/ai/ai-rules-neon-toolkit">
