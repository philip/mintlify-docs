...
<CardGroup>
  ...
  <Card title="Semantic search chatbot (OpenAI + LangChain)" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase/examples/tree/main/ai/langchain/semantic-search-nextjs">
