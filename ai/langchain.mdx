...
<CardGroup>
  ...
  <Card title="Semantic search chatbot (OpenAI + LangChain)" icon="github" href="https://github.com/neondatabase/examples/tree/main/ai/langchain/semantic-search-nextjs">
