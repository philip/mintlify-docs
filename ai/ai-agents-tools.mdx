...
<CardGroup>
  ...
  <Card title="Neon MCP Server" icon="github" href="/ai/neon-mcp-server">
    Learn about managing your Neon projects using natural language with Neon MCP Server
  </Card>
  <Card title="Connect MCP clients" icon="github" href="/ai/connect-mcp-clients-to-neon">
...
<CardGroup>
  ...
  <Card title="Claude Code plugin for Neon" icon="github" href="/ai/ai-claude-code-plugin">
...
<CardGroup>
  ...
  <Card title="Cursor plugin for Neon" icon="github" href="/ai/ai-cursor-plugin">
...
<CardGroup>
  ...
  <Card title="Neon agents for GitHub Copilot" icon="github" href="/ai/ai-github-copilot-agents">
...
<CardGroup>
  ...
  <Card title="Neon Auth" icon="github" href="/ai/ai-rules-neon-auth">
    AI rules for implementing authentication with Neon
  </Card>
  <Card title="Neon Drizzle" icon="github" href="/ai/ai-rules-neon-drizzle">
    AI rules for using Drizzle ORM with Neon
  </Card>
  <Card title="Neon Serverless Driver" icon="github" href="/ai/ai-rules-neon-serverless">
    AI rules for serverless database connections
  </Card>
  <Card title="Neon API TypeScript SDK" icon="github" href="/ai/ai-rules-neon-typescript-sdk">
    AI rules for using the Neon API TypeScript SDK
  </Card>
  <Card title="Neon Python SDK" icon="github" href="/ai/ai-rules-neon-python-sdk">
    AI rules for using the Neon Python SDK
  </Card>
  <Card title="Neon API" icon="github" href="/ai/ai-rules-neon-api">
    AI rules for using the Neon API
  </Card>
  <Card title="Neon Toolkit" icon="github" href="/ai/ai-rules-neon-toolkit">
...
<CardGroup>
  ...
  <Card title="Neon for AI agent platforms" icon="openai" href="https://neon.com/use-cases/ai-agents">
    Read about Neon as a solution for agents that need backends.
  </Card>

  <Card title="@neondatabase/toolkit" icon="github" href="https://github.com/neondatabase/toolkit">
    A terse JavaScript client for spinning up Postgres databases and running SQL queries
  </Card>

  <Card title="Database versioning" icon="openai" href="/ai/ai-database-versioning">
    How AI agents and codegen platforms use Neon snapshot APIs for database versioning
  </Card>

  <Card title="Neon API" icon="transactions" href="/reference/api-reference">
...
<CardGroup>
  ...
  <Card title="AgentStack Integration" icon="openai" href="/guides/agentstack-neon">
    Build and deploy AI agents with AgentStack's CLI and Neon integration
  </Card>
  <Card title="AutoGen Integration" icon="openai" href="/guides/autogen-neon">
    Create collaborative AI agents with Microsoft AutoGen and Neon
  </Card>
  <Card title="Azure AI Agent Service" icon="openai" href="/guides/azure-ai-agent-service">
    Build enterprise AI agents with Azure AI Agent Service and Neon
  </Card>
  <Card title="Composio + CrewAI" icon="openai" href="/guides/composio-crewai-neon">
    Create multi-agent systems with CrewAI and Neon
  </Card>
  <Card title="LangGraph Integration" icon="openai" href="/guides/langgraph-neon">
