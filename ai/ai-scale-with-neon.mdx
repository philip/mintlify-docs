...
See [Edit a compute](/manage/computes#edit-a-compute) to configure your compute size. Available compute sizes differ according to your Neon plan.
...
To learn more about Neon's autoscaling feature and how to enable it, refer to our [Autoscaling guide](/introduction/autoscaling).

## Storage

On the Free plan, you get 0.5 GB of storage plus 0.5 GB of storage per branch. Storage on paid plans is usage based. See [Neon plans](/introduction/plans) for details.
...
To learn more about the Neon read replicas, see [read replicas](/introduction/read-replicas) and refer to our [Working with Neon read replicas](/guides/read-replica-guide) guide.
