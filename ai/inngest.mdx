...
<CardGroup>
  ...
  <Card title="RAG starter (OpenAI + Inngest)" icon="github" href="https://github.com/neondatabase/examples/tree/main/ai/inngest/rag-starter-nextjs">
    A Next.js RAG starter app built with OpenAI and Inngest
  </Card>

  <Card title="multi-tenant RAG (OpenAI + Inngest)" icon="github" href="https://github.com/inngest/multi-tenant-rag-example">
    A Next.js contacts importer multi-tenant RAG built with OpenAI and Inngest
  </Card>

  <Card title="Auto-embedding (OpenAI + Inngest)" icon="github" href="https://github.com/neondatabase/examples/tree/main/ai/inngest/auto-embeddings-nextjs">
