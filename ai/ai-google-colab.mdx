...
description: >-
  Step-by-step guide for using Google Colab with Neon to create a notebook,
  connect to a Neon database, install the `pgvector` extension, and execute
...
To perform the steps in this guide, you require a Neon database for storing vectors. You can use the ready-to-use `neondb` database or create your own. See [Create a database](/manage/databases#create-a-database) for instructions.
...
![Google Colab](/images/docs/ai/google_colab.png)
...
For more information about using Neon with `pgvector`, see [The pgvector extension](/extensions/pgvector).
