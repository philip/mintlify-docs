...
<CardGroup>
  ...
  <Card title="RAG .NET console app (Azure OpenAI + Semantic Kernel)" icon="/images/technology-logos/github.svg" href="https://github.com/neondatabase-labs/neon-semantic-kernel-examples">
