...
<a href="/data-api/overview">Neon Data API</a>
  <a href="/data-api/custom-authentication-providers">Custom authentication providers</a>
  <a href="/guides/neon-rls">Row-Level Security (RLS)</a>
...
This extension powers the [Neon Data API](/data-api/overview), enabling secure session management and Row-Level Security (RLS) based on user identity.
...
The `pg_session_jwt` extension is automatically configured when you enable the [Neon Data API](/data-api/overview). The Data API handles JWT validation using your configured authentication provider's JWKS URL.
...
- [Neon Data API documentation](/data-api/overview)
- [Custom authentication providers](/data-api/custom-authentication-providers)
- [Row-Level Security guide](/guides/neon-rls)
