...
<Tip title="Looking for a practical guide?">
For complete step-by-step workflows on anonymizing data in Neon branches, including manual procedures and GitHub Actions automation, see [data anonymization](/workflows/data-anonymization).
</Tip>

## Enable the extension

<Note>
This extension is currently [experimental](/extensions/pg-extensions#experimental-extensions) and may change in future releases.
</Note>
...
1. Connect to your Neon database using either the [Neon SQL Editor](/get-started/query-with-neon-sql-editor) or an SQL client like [psql](/connect/query-with-psql-editor)
...
<Tip>
When using the Neon Console or API to create branches, the extension is enabled automatically. See the [data anonymization workflow guide](/workflows/data-anonymization) for details.
</Tip>
...
For complete implementation examples showing how to apply these masking functions in real workflows, see the [data anonymization guide](/workflows/data-anonymization), which covers:
...
- [Data anonymization workflow guide](/workflows/data-anonymization) - Practical guide for anonymizing data in Neon branches
