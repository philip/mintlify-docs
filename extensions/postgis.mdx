...
<Note>
    ...
    For information about PostGIS-related extensions, including `pgrouting`, H3_PostGIS, PostGIS SFCGAL, and PostGIS Tiger Geocoder, see [PostGIG-related extensions](/extensions/postgis-related-extensions).
</Note>

**Version availability:**

Please refer to the [list of all extensions](/extensions/pg-extensions) available in Neon for up-to-date information.
