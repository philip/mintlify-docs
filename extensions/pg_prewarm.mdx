...
Please refer to the [list of extensions](/extensions/pg-extensions) available in Neon for information about the version of `pg_prewarm` that Neon supports.
...
5. Calculate the total size of the data loaded into the cache using the block size and the number of blocks loaded:
   ...
   To understand how much memory is available to your Postgres instance on Neon, see [How to size your compute](/manage/computes#how-to-size-your-compute).
   </Note>
...
2. Restart your Postgres instance to clear the cache. On Neon, you can do this by [restarting your compute](/manage/computes#restart-a-compute).
...
- [How to size your compute in Neon](/manage/computes#how-to-size-your-compute)
