...
<Warning title="Modifying the default intdict dictionary on Neon">
...
<Warning title="Modifying default text search configurations on Neon">
...
- [Postgres tsvector data type](/data-types/tsvector)
